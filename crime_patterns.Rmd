...
num_k = length(unique(df_nypd |> pull(ky_cd)))
num_p = length(unique(df_nypd |> pull(pd_cd)))
num_k
num_p
```
Decide to use ky_cd as crime classification code to avoid excessive complication.
...
<iframe height="600" width="100%" frameborder="no" src=" https://xinyi-anna-shang.shinyapps.io/Top10CrimetTypes/">
