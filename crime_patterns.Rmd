...
p_1 = df_crime_patterns |>
  ...
  summarize(count = n()) |> 
  ggplot(aes(x = year, y = count)) + geom_line() + facet_wrap(~ofns_desc, ncol = 5)+
  xlab("Year") +ylab("Number of Cases") + 
  theme_minimal() +
  theme(strip.background = element_rect(fill = "lightblue", color = "lightblue"))
...
<iframe height="600" width="100%" frameborder="no" src="https://allisonzxia.shinyapps.io/Crime_Map_Shiny/"> </iframe>
