...
<div style="display: flex; flex-wrap: nowrap; overflow-x: auto; white-space: nowrap;">
  <div style="flex: 0 0 auto; margin-left: 20px; margin-right: 80px; text-align: center;">
    <img src="image/IMG_2082.JPG" alt="haha" style="width: 200px; height: 200px; object-fit: cover; object-position: center center; border-radius: 50%;">
...
<div style="display: flex; flex-wrap: nowrap; overflow-x: auto; white-space: nowrap;">
  ...
  <div style="flex: 0 0 auto; margin-left: 20px; margin-right: 80px; text-align: center;">
    <img src="image/miao_fu.jpg" alt="haha" style="width: 200px; height: 200px; object-fit: cover; object-position: center center; border-radius: 50%;">
    <p><strong>Miao Fu</strong><br>mf3593</p>
  </div>

  <div style="flex: 0 0 auto; margin-right: 80px; text-align: center;">
    <img src="image/xinyi_shang.jpg" alt="haha" style="width: 200px; height: 200px; object-fit: cover; object-position: center center; border-radius: 50%;">
