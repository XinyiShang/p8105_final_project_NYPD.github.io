...
<div style="display: flex; flex-wrap: nowrap; overflow-x: auto; white-space: nowrap;">
  <div style="flex: 0 0 auto; margin-left: 50px; margin-right: 100px; text-align: center;">
    <img src="image/new_york.jpg" alt="haha" style="width: 150px; height: 150px; border-radius: 50%;">
    <p><strong>Yuki Joyama</strong><br>yj2803</p>
  </div>
  
  <div style="flex: 0 0 auto; margin-right: 100px; text-align: center;">
    <img src="image/new_york.jpg" alt="haha" style="width: 150px; height: 150px; border-radius: 50%;">
    <p><strong>Nihaal Rahman</strong><br>nkr2121</p>
  </div>
  
  <div style="flex: 0 0 auto; margin-right: 50px; text-align: center;">
    <img src="image/new_york.jpg" alt="haha" style="width: 150px; height: 150px; border-radius: 50%;">
...
<div style="display: flex; flex-wrap: nowrap; overflow-x: auto; white-space: nowrap;">
  ...
  <div style="flex: 0 0 auto; margin-right: 100px; text-align: center;">
    <img src="image/xinyi.jpg" alt="Xinyi Shang" style="width: 150px; height: 150px; border-radius: 50%;">
