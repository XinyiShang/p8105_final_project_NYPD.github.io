...
As we removed many insignificant predictors, education factor lost its significance as well. Our final model will only include two predictors: percentage of population below poverty line and median household income. 
...
Both of these 2 predictors are significant. We can also check for multicollinearity of our optimized model

```{r}
performance::check_collinearity(log_fit_optimized)
```

Multicollinearity is low between our two predictors and is within the acceptable range. 
