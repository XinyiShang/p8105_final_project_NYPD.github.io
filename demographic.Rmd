...
```{r,include=FALSE}
final=grid.arrange(
  sex_borough_plot + theme(legend.position = "bottom",legend.key.size = unit(1, "lines"),legend.text = element_text(size = 6))+ggtitle(NULL),
  race_borough_plot+ theme(legend.position = "bottom",legend.key.size = unit(0.3, "lines"),legend.text = element_text(size = 4))+ggtitle(NULL),
  age_borough_plot + theme(legend.position = "none")+ggtitle(NULL),
